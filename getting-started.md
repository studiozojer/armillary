...
#### repos/
Contains your codebases, similar to a monorepo. Your repos in here all get .gitignored, so they're agnostic to the armillary. But the benefit of this system is that you can access any of your repos from the same access point.
#### commons/
Basically, a knowledge base. A repository pattern designed to hold bespoke protocols, wikis, documents, specs, etc. Commons are designed to be extremely agnostic; I have a base template [here](https://github.com/studiozojer/commons/tree/main), but you can structure these however you want. The point of this category is to delineate your shared workspaces with people.
